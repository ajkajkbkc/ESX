...
void TEMPMON_Init(TEMPMON_Type *base, const tempmon_config_t *config)
{
    ...
    LOGW("tempmon", "calibrationData = 0x%08X", calibrationData);
    ...
    LOGV("tempmon", "s_hotTemp = %u, s_hotCount = %u, roomCount = %u", s_hotTemp, s_hotCount, roomCount);
    s_hotT_ROOM  = (float)s_hotTemp - TEMPMON_ROOMTEMP;
    s_roomC_hotC = roomCount - s_hotCount;
    LOGD("tempmon", "s_hotT_ROOM = %f, s_roomC_hotC = %u", s_hotT_ROOM, s_roomC_hotC);
